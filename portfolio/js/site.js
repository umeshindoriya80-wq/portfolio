...
/* ── CurvedLoop ── */
(function () {
  const TEXT  = 'DESIGN FOR TRUST ✶ 4+ YEARS EXPERIENCE ✶ M.DES IIT GUWAHATI ✶ THOUGHTSPOT ✶ ENTERPRISE UX ✶ AI & ANALYTICS ✶ PREVIOUSLY NUTANIX ✶ CONVERSATIONAL AI ✶ B2B SAAS ✶ 0→1 PRODUCT DESIGN ✶ ';
  const SPEED = 0.35;
